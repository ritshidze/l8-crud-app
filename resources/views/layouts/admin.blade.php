            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="company" aria-labelledby="headingTwo"
                            data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                <a class="nav-link collapsed" href="{{route('company')}}" data-toggle=""
                                    data-target="" aria-expanded="false" aria-controls=""><i
                                        class="fas fa-list"></i>&nbsp;LIST COMPANIES
                                </a>
                                <a class="nav-link collapsed" href="{{route('create-company')}}" data-toggle=""
                                    data-target="" aria-expanded="false" aria-controls=""><i
                                        class="fas fa-user"></i>&nbsp;ADD COMPANY
                                </a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="employee" aria-labelledby="headingOne"
                            data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link collapsed" href="{{route('employee')}}" data-toggle=""
                                    data-target="" aria-expanded="false" aria-controls=""><i
                                        class="fas fa-list"></i>&nbsp;LIST EMPLOYEES
                                </a>
                                <a class="nav-link collapsed" href="{{route('create-employee')}}" data-toggle=""
                                    data-target="" aria-expanded="false" aria-controls=""><i
                                        class="fas fa-user"></i>&nbsp;ADD EMPLOYEE
                                </a>
                            </nav>
                        </div>
                    </div>
